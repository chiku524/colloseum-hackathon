...
export const BRAND_DESCRIPTION =
  'Vault: secure team escrow on Solana — policy templates, multi-approver releases, artifacts, and disputes. A creator treasury you can lock down, govern, and audit.';
