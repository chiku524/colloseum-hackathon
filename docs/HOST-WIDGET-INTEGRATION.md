...
This page is the canonical checklist for embedding **Vault** read-only treasury status in **your** app and optionally receiving **`postMessage`** updates from the iframe.
