...
This page is the canonical checklist for embedding **Lithos** read-only treasury status in **your** app and optionally receiving **`postMessage`** updates from the iframe.
